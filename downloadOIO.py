...
with open("C:/Users/jsruj/Desktop/mlprojects/airbnb_project/class-descriptions-boxable.csv", mode="r") as infile:
...
for ind in range(0, len(classes)):
    ...
    command = "grep "+ dict_list[class_name.replace("_", " ")] + "C:/Users/jsruj/Desktop/mlprojects/airbnb_project/" + dataset + "-annotations-bbox.csv"
    print(command)
