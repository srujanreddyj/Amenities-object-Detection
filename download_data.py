#### Usage example: python3 download_data.py --classes 'Ice_cream,Cookie' --mode train
...
with open('/home/newlearningsrujan/dl-projects/airbnb_amenity_project/class-descriptions-boxable.csv', mode='r') as infile:
...
for ind in range(0, len(classes)):
    ...
    command = "grep "+dict_list[class_name.replace('_', ' ')] + "/home/newlearningsrujan/dl-projects/airbnb_amenity_project/" + run_mode + "-annotations-bbox.csv"
